    ...
    <div className="space-y-4">
      <div className="flex items-center gap-4">
        <input
          ...
          className="border px-4 py-2 rounded w-full max-w-xl bg-gray-800 text-gray-200"
        />
        <button
          onClick={() => setShowMap(!showMap)}
          className="px-4 py-2 border rounded flex items-center gap-2 bg-gray-700 text-gray-200 hover:bg-gray-600"
        >
          <span>🗺️</span>
      ...
      {showMap && (
        <div className="mb-6">
          <div className="h-64 bg-gray-700 flex items-center justify-center text-gray-300">
            <p>Map Placeholder</p>
          </div>
        </div>
      )}
      ...
      <div className="grid gap-4">
        {filteredResources.length === 0 ? (
          ...
          filteredResources.map((resource) => (
            <div
              key={resource.id}
              className="border rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow bg-gray-900 text-gray-200"
            >
